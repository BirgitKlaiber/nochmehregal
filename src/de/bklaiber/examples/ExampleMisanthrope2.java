...
public class ExampleMisanthrope2
{
	public static void main(String[] args)
	{
		...
		reader.read("ressources/fileExamples/relational/Misanthrope.rcl");
		...
		Collection<RelationalConditional> knowledgebase = reader.getConditionals();
