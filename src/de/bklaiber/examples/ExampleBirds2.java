...
public class ExampleBirds2
{
	public static void main(String[] args)
	{
		...
		reader.read("ressources/fileExamples/relational/Birds.rcl");
		...
		System.out.println("Beispiel einer Anfrage:");
		...
		{
			Formula<RelationalAtom> cond = new RelationalAtom(flies, constant);
