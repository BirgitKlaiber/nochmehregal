...
public class ExampleElephants2
{
	...
	public static void main(String[] args)
	{
		...
		reader.read("ressources/fileExamples/relational/Elephants.rcl");
		...
		PossibleWorldFactory<RelationalAtom> worldFactory = new RelationalPossibleWorld64BitRepresentationFactory();
		...
		System.out.println("Is consistent? "+ satTest.isSatisfiable(knowledgebase));
		...
		for (RelationalConditional relationalConditional : groundKnowledgeBase)
		{
			...
			for(Atom<RelationalAtom> a: relationalConditional.getConsequence().getAtoms()) System.out.println(((RelationalAtom) a).getConstants().iterator().next());	
		}
