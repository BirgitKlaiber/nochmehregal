...
public class ExampleMisanthropeIrreflexive
{
	...
	public static void main(String[] args)
	{
		...
		RelationalAtom likesUU = new RelationalAtom(likes, U, U);
		...
		RelationalFact fact2 = new RelationalFact(likesUU, new Fraction(0, 100));
