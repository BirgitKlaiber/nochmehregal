...
public class ReflexiveNegativeTest extends AbstractQueryTest {

	private Sort type;
	private Sort[] argumentSorts;
	Formula<AtomicConstraint> reflexiveNegativeConstraint = null;

	@Test
	public void testReflexiveNegativeGeneralization() {
		...
		reflexiveNegativeConstraint = generalization.generateReflexiveNegativeConstraint(atomsOfQuery);
		Vector<Formula<AtomicConstraint>> constraints = new Vector<Formula<AtomicConstraint>>();
		constraints.addElement(reflexiveNegativeConstraint);
